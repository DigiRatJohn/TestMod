package net.digirat.mods.gui;

import net.digirat.mods.References;
import net.digirat.mods.blocks.testcontainer.TestContainer;
...
public class TestContainerGui extends GuiContainer {
	...
	private static final ResourceLocation background = new ResourceLocation(References.MODID, "textures/gui/testcontainer.png");
